...
const HeroSection = () => {
  return (
    <section
      id="hero-section"
      className="relative w-full h-[50vh] overflow-hidden mb-8 md:mb-0 lg:mb-0 xl:mb-8"
    >
      {/* Background gradient */}
          ...
          <div className="flex flex-col items-center justify-center text-center space-y-3 md:space-y-0 lg:space-y-0 xl:space-y-3">
            ...
            <div className="space-y-1 md:space-y-0 lg:space-y-0 xl:space-y-1 animate-slide-up">
              <h1 className="flex items-end justify-center font-black tracking-tight leading-none font-outfit">
                <span className="text-[8rem] sm:text-[8rem] md:text-[1rem] lg:text-[1.4rem] xl:text-[20rem] text-verde-neon drop-shadow-[0_0_40px_rgba(0,255,127,0.6)] neon-text leading-none">
                  50%
                </span>
                <span className="text-[4rem] sm:text-[4rem] md:text-[0.5rem] lg:text-[0.7rem] xl:text-[10rem] text-blanco ml-1 md:ml-0.5 lg:ml-0.5 mb-1 md:mb-0 lg:mb-0 leading-none">
                  off
                </span>
              </h1>

              {/* Separator line - HIDDEN at md/lg */}
              ...
              <p className="text-3xl sm:text-3xl md:text-[5px] lg:text-[6px] xl:text-[54px] text-white font-medium font-inter tracking-wide leading-none m-0 mb-1 md:mb-0 lg:mb-0">
                cachetadas de
              </p>

              {/* DESCUENTOS% */}
              <h2 className="text-[33px] sm:text-[33px] md:text-[6px] lg:text-[8px] xl:text-[57px] font-black text-blanco tracking-[0.2em] md:tracking-[0.08em] lg:tracking-[0.1em] uppercase font-outfit leading-none m-0">
