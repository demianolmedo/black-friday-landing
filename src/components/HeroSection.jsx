          ...
          <div className="flex flex-col items-center justify-center text-center space-y-3">
            ...
            <div className="space-y-1 animate-slide-up">
              <h1 className="flex items-end justify-center font-black tracking-tight leading-none font-outfit">
                <span className="text-[5rem] sm:text-[8rem] md:text-[12rem] lg:text-[16rem] xl:text-[20rem] text-verde-neon drop-shadow-[0_0_40px_rgba(0,255,127,0.6)] neon-text">
                  50%
                </span>
                <span className="text-[2.5rem] sm:text-[4rem] md:text-[6rem] lg:text-[8rem] xl:text-[10rem] text-blanco ml-2 mb-1">
                  off
                </span>
              </h1>
              ...
              <p className="text-xl sm:text-3xl md:text-[33px] lg:text-[42px] xl:text-[54px] text-white font-medium font-inter tracking-wide leading-none m-0 mb-1">
                cachetadas de
              </p>

              {/* DESCUENTOS% */}
              <h2 className="text-2xl sm:text-[33px] md:text-[36px] lg:text-[45px] xl:text-[57px] font-black text-blanco tracking-[0.3em] uppercase font-outfit leading-none m-0">
