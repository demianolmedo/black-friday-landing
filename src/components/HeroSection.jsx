        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="flex flex-col items-center justify-center text-center space-y-3 md:space-y-0 lg:space-y-0 xl:space-y-3">
            ...
            <div className="space-y-1 md:space-y-0 lg:space-y-0 xl:space-y-1 animate-slide-up">
              <h1 className="flex items-end justify-center font-black tracking-tight leading-[0.8] font-outfit">
                <span className="text-[8rem] sm:text-[8rem] md:text-[3.5rem] lg:text-[4.5rem] xl:text-[20rem] text-verde-neon drop-shadow-[0_0_40px_rgba(0,255,127,0.6)] neon-text">
                  50%
                </span>
                <span className="text-[4rem] sm:text-[4rem] md:text-[1.75rem] lg:text-[2.25rem] xl:text-[10rem] text-blanco ml-2 mb-1 md:mb-0 lg:mb-0">
                  off
                </span>
              </h1>
              ...
              <p className="text-3xl sm:text-3xl md:text-[14px] lg:text-[16px] xl:text-[54px] text-white font-medium font-inter tracking-wide leading-none m-0 mb-1 md:mb-0 lg:mb-0">
                cachetadas de
              </p>

              {/* DESCUENTOS% */}
              <h2 className="text-[33px] sm:text-[33px] md:text-[16px] lg:text-[18px] xl:text-[57px] font-black text-blanco tracking-[0.3em] uppercase font-outfit leading-none m-0">
