      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-0 relative animate-scale-in">
            ...
            <div className="bg-white/[0.03] backdrop-blur-2xl border border-white/[0.08] rounded-3xl px-16 py-10 text-center shadow-lg hover:bg-white/[0.05] hover:border-[#00FF7F]/20 hover:-translate-y-0.5 transition-all duration-300 w-full md:w-auto max-w-xs">
            ...
            <div className="bg-white/[0.03] backdrop-blur-2xl border border-white/[0.08] rounded-3xl px-16 py-10 text-center shadow-lg hover:bg-white/[0.05] hover:border-[#00FF7F]/20 hover:-translate-y-0.5 transition-all duration-300 w-full md:w-auto max-w-xs">
              ...
              <p className="text-white/60 text-[13px] font-inter leading-tight mb-1">
